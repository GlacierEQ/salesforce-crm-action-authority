"""CRM Action Authority — SCAFFOLD STUB.

Company lens: Salesforce (independent; no affiliation).
Bottleneck: Trusted autonomous action over CRM context and enterprise integration layers.
...
class CrmActionAuthority:
    ...
    - `evaluate(req)` returns a CrmActionAuthorityReceipt
